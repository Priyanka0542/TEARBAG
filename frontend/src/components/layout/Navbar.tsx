    ...
    <nav className="fixed top-0 w-full z-50 bg-background/30 backdrop-blur-3xl border-b border-white/5">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 text-sm font-medium">
          ...
          <Link 
            to="/analytics" 
            className={`relative px-4 py-2 rounded-full transition-colors flex items-center space-x-2 ${location.pathname === '/analytics' ? 'text-primary' : 'text-muted-foreground hover:text-foreground'}`}
          >
          ...
          <Link 
            to="/companion" 
            className={`relative px-4 py-2 rounded-full transition-colors flex items-center space-x-2 ${location.pathname === '/companion' ? 'text-primary' : 'text-muted-foreground hover:text-foreground'}`}
          >
          ...
          <Link 
            to="/community" 
            className={`relative px-4 py-2 rounded-full transition-colors flex items-center space-x-2 ${location.pathname === '/community' ? 'text-blue-500' : 'text-muted-foreground hover:text-foreground'}`}
          >
