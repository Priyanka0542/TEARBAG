...
export const Login = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/20 rounded-full blur-[100px] -z-10 mix-blend-screen pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-pink-500/20 rounded-full blur-[100px] -z-10 mix-blend-screen pointer-events-none" />
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 text-left">
            ...
            <motion.button 
              ...
              type="submit" 
              disabled={loading}
              className="w-full mt-4 bg-primary text-primary-foreground py-4 rounded-2xl flex items-center justify-center space-x-2 hover:bg-primary/90 transition-all disabled:opacity-70 font-medium text-lg shadow-lg shadow-primary/20"
            >
              {loading ? <Loader2 className="w-6 h-6 animate-spin" /> : (
                <>
                  <span>{isLogin ? 'Enter Vault' : 'Create Vault'}</span>
